  ...
  return (
        <div key={data.id} className="flex">
          ...
          <div>
            ...
            <button type="button" onClick={() => handleUpdate(data.id, data)}
        ...
        <button type="button" onClick={() => handleDelete(data.id)}
          ...
          Delete
            ...
            <Link to={`/details/${data.id}`} state={{data: data}}><h5 className="text-white text-xl font-medium pt-2 pl-2">{data.title}</h5></Link>
